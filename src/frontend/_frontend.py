...
def setup_frontend(manager: MangaManager, find: FindService, spider: SpiderManager) -> FastAPI:
    app = FastAPI(title="Manga Day", description="Сайт для просмотра мангиг")

    shared_templates = Jinja2Templates(
...
async def start_frontend(manager: MangaManager, find: FindService, spider: SpiderManager) -> None:
